# Generated by Django 3.2 on 2021-08-02 08:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('baseIRPF1T', models.FloatField()),
                ('reten1T', models.FloatField()),
                ('presentado1T', models.BooleanField(default=False)),
                ('baseIRPF2T', models.FloatField()),
                ('reten2T', models.FloatField()),
                ('presentado2T', models.BooleanField(default=False)),
                ('baseIRPF3T', models.FloatField()),
                ('reten3T', models.FloatField()),
                ('presentado3T', models.BooleanField(default=False)),
                ('baseIRPF4T', models.FloatField()),
                ('reten4T', models.FloatField()),
                ('presentado4T', models.BooleanField(default=False)),
                ('base190', models.FloatField()),
                ('reten190', models.FloatField()),
